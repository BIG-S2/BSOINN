...
// [[Rcpp::export]]
List BSOIFull(vec Y, mat xi, mat Z_cov, int n_iter, double alpha_0, double sigma2_alpha0, vec beta_k0, vec sigma2_betak0, vec gamma_q0, vec sigma2_gammaq0,double a_delta0, double b_delta0,  double alpha, vec beta, vec gamma_cov, double sigma2_delta) {
